...
from ..config.consts import PATH_PREFIX, POST_ADD_PRODUCT, POST_UPDATE_QUAN, POST_DELETE_PROD, GET_GET_PRODS
...
# Product 
@apiRouter.post(POST_ADD_PRODUCT, response_model = List[Product])
...
@apiRouter.post(POST_UPDATE_QUAN, response_model = List[Product])
